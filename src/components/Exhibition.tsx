    ...
    return ( 
        <div className="Exhibition">
            <div className="item-1">
                <img className="thumbnail-image" src= "/images/thumbnail1.png" alt="thumbnail"/>
                <div className="tech-stack">
                    <span className="tech-stack-text">Python Tensorflow</span>
                </div>
                <div className="project-name">
                    <span className="project-name-text">CNNCLassifier</span>
                </div>
                <div className="project-description">
                    <span className="project-description-text">Machine learning model that classifies images</span>
                </div>
                <button className="live-button">
                    <span className="live-button-text">Live</span>
